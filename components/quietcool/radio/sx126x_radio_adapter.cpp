#include "sx126x_radio_adapter.h"
...
::quietcool::RadioSendResult Sx126xRadioAdapter::send_packet(
  ...
  if (result == sx126x::SX126xError::INVALID_PARAMS)
    return ::quietcool::RadioSendResult::Rejected;
  return ::quietcool::RadioSendResult::Fault;
}

::quietcool::RadioRecoveryResult Sx126xRadioAdapter::recover() {
  radio_.configure();
